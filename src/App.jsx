  ...
  return (
    <div id="appBody" className=" p-0 m-0">
      ...
      <section
        ...
        className="container-flex min-h-screen sm:relative shadow-2xl relative overflow-clip"
      >
        {/*this video is the background */}
        <video autoPlay muted loop src={bgVideo} id="myvideo"></video>
        <div className="bg-black bg-opacity-50 min-h-screen"></div>
        <h3 className="font-bold text-center text-3xl sm:text-8xl text-white uppercase absolute top-8 left-10">sala tecnica</h3>
      </section>
        ...
        <div>
          ...
          {ServiceList &&
            ServiceList.map((data, x) => {
              return (
                <a key={x} className="link link-hover lowercase">
                  {data.title}
                </a>
              );
            })}
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
       ...
       <img src="/icon.png" alt="logo de gps" className="w-12 h-12" />
          <p>
            Gerencia de Proyectos y Servicios. <br />
            2015
          </p>
        </div>
